...
export default function RejectedPropertiesPage() {
    ...
    const [filters, setFilters] = React.useState<PropertyFilterValues>({
        ...
        propertyTypes: [],
        permitNumber: '',
        status: 'rejected', // Initialize with rejected
        minPrice: 0,
        maxPrice: 100000000,
        minArea: 0,
        maxArea: 50000,
            ...
            <div className="flex-1 p-8 max-w-[1600px] mx-auto h-screen flex flex-col overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-6 flex-shrink-0">
                    <h1 className="text-[24px] font-semibold text-[#1A1A1A]" style={{ fontFamily: 'var(--font-montserrat)' }}>
                        Rejected / Unverified Properties <span className="text-[#8F9BB3] font-medium ml-1">({totalCount})</span>
                    </h1>
                </div>
                ...
                <div className="flex-1 min-h-0">
                    {isLoading ? (
                        ...
                        <div className="flex flex-col items-center justify-center py-20 text-center">
                            ...
                            <h3 className="text-lg font-medium text-gray-900 mb-1">No rejected properties found</h3>
                            <p className="text-gray-500 max-w-sm mx-auto">
                                All active properties seem to be verified and approved by Property Finder.
                            </p>
                        </div>
                    ) : (
                        <VirtuosoGrid
